...
void AnalysisBranches::initialiseVariables(Looper *l) {
	...
	l->B_s0_MMERRoMM                         = new Double_t(0);
	...
	l->Kminus_ProbNNpiKp                     = new Double_t(0);
	...
	l->Kplus_ProbNNpiKp                      = new Double_t(0);
	...
	l->Piminus_ProbNNpiKp                    = new Double_t(0);
	...
	l->Piplus_ProbNNpiKp                     = new Double_t(0);
	...
	l->max_kaon_PIDK                         = new Double_t(0);
	l->max_kaon_ProbNNk                      = new Double_t(0);
	l->max_kaon_ProbNNp                      = new Double_t(0);
	l->max_kaon_ProbNNpi                     = new Double_t(0);
	l->max_kaon_ProbNNpiKp                   = new Double_t(0);
	l->max_pion_PIDK                         = new Double_t(0);
	l->max_pion_ProbNNk                      = new Double_t(0);
	l->max_pion_ProbNNp                      = new Double_t(0);
	l->max_pion_ProbNNpi                     = new Double_t(0);
	l->max_pion_ProbNNpiKp                   = new Double_t(0);
	l->max_track_chi2                        = new Double_t(0);
	l->min_kaon_PIDK                         = new Double_t(0);
	l->min_kaon_ProbNNk                      = new Double_t(0);
	l->min_kaon_ProbNNp                      = new Double_t(0);
	l->min_kaon_ProbNNpi                     = new Double_t(0);
	l->min_kaon_ProbNNpiKp                   = new Double_t(0);
	l->min_pion_PIDK                         = new Double_t(0);
	l->min_pion_ProbNNk                      = new Double_t(0);
	l->min_pion_ProbNNp                      = new Double_t(0);
	l->min_pion_ProbNNpi                     = new Double_t(0);
	l->min_pion_ProbNNpiKp                   = new Double_t(0);
...
void AnalysisBranches::cleanVariables(Looper *l) {
	...
	delete l->max_kaon_PIDK;
	delete l->max_kaon_ProbNNk;
	delete l->max_kaon_ProbNNp;
	delete l->max_kaon_ProbNNpi;
	delete l->max_kaon_ProbNNpiKp;
	delete l->max_pion_PIDK;
	delete l->max_pion_ProbNNk;
	delete l->max_pion_ProbNNp;
	delete l->max_pion_ProbNNpi;
	delete l->max_pion_ProbNNpiKp;
	delete l->max_track_chi2;
	delete l->min_kaon_PIDK;
	delete l->min_kaon_ProbNNk;
	delete l->min_kaon_ProbNNp;
	delete l->min_kaon_ProbNNpi;
	delete l->min_kaon_ProbNNpiKp;
	delete l->min_pion_PIDK;
	delete l->min_pion_ProbNNk;
	delete l->min_pion_ProbNNp;
	delete l->min_pion_ProbNNpi;
	delete l->min_pion_ProbNNpiKp;
...
void AnalysisBranches::setOutputBranches(Looper *l, TTree *tree){ 
	...
	tree->Branch("B_s0_MMERRoMM",l->B_s0_MMERRoMM);
	...
	tree->Branch("Kminus_ProbNNpiKp",l->Kminus_ProbNNpiKp);
	...
	tree->Branch("Kplus_ProbNNpiKp",l->Kplus_ProbNNpiKp);
	...
	tree->Branch("Piminus_ProbNNpiKp",l->Piminus_ProbNNpiKp);
	...
	tree->Branch("Piplus_ProbNNpiKp",l->Piplus_ProbNNpiKp);
	...
	tree->Branch("max_kaon_PIDK",l->max_kaon_PIDK);
	tree->Branch("max_kaon_ProbNNk",l->max_kaon_ProbNNk);
	tree->Branch("max_kaon_ProbNNp",l->max_kaon_ProbNNp);
	tree->Branch("max_kaon_ProbNNpi",l->max_kaon_ProbNNpi);
	tree->Branch("max_kaon_ProbNNpiKp",l->max_kaon_ProbNNpiKp);
	tree->Branch("max_pion_PIDK",l->max_pion_PIDK);
	tree->Branch("max_pion_ProbNNk",l->max_pion_ProbNNk);
	tree->Branch("max_pion_ProbNNp",l->max_pion_ProbNNp);
	tree->Branch("max_pion_ProbNNpi",l->max_pion_ProbNNpi);
	tree->Branch("max_pion_ProbNNpiKp",l->max_pion_ProbNNpiKp);
	tree->Branch("max_track_chi2",l->max_track_chi2);
	tree->Branch("min_kaon_PIDK",l->min_kaon_PIDK);
	tree->Branch("min_kaon_ProbNNk",l->min_kaon_ProbNNk);
	tree->Branch("min_kaon_ProbNNp",l->min_kaon_ProbNNp);
	tree->Branch("min_kaon_ProbNNpi",l->min_kaon_ProbNNpi);
	tree->Branch("min_kaon_ProbNNpiKp",l->min_kaon_ProbNNpiKp);
	tree->Branch("min_pion_PIDK",l->min_pion_PIDK);
	tree->Branch("min_pion_ProbNNk",l->min_pion_ProbNNk);
	tree->Branch("min_pion_ProbNNp",l->min_pion_ProbNNp);
	tree->Branch("min_pion_ProbNNpi",l->min_pion_ProbNNpi);
	tree->Branch("min_pion_ProbNNpiKp",l->min_pion_ProbNNpiKp);
	...
	tree->Branch("pass_pid",l->pass_pid);
