...
#include "../interface/PreSelBranches.h"

PreSelBranches::PreSelBranches(){} 																	 

PreSelBranches::~PreSelBranches(){} 																	 

void PreSelBranches::setInputBranches(Looper *l, TTree *tree){ 
...
void PreSelBranches::initialiseVariables(Looper *l) {
...
void PreSelBranches::cleanVariables(Looper *l) {
...
void PreSelBranches::setOutputBranches(Looper *l, TTree *tree){ 
